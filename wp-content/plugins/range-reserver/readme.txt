=== Range Reserver ===
Contributors: loncar
Donate link: https://range-reserver.net/
...
== Description ==
Add Booking Appointments system to your WordPress site and manage Appointments with ease. Extremely flexible time management. Multiple location, bays and lanes. Email notifications.

Can be used for : <strong>Lawyers</strong>, <strong>Salons</strong>, <strong>Mechanic</strong>, <strong>Cleaning bays</strong>, <strong>Doctors</strong>, <strong>Spas</strong>, <strong>Personal trainers </strong>, <strong>Private Lessons</strong>, <strong>Escape rooms</strong> etc,

= Live Demo =
<a href="https://range-reserver.net/responsive-single-column-layout/">**Responsive Appointment form**</a><br>
<a href="https://range-reserver.net/responsive-two-columns/">**Responsive Appointment form - two column layout**</a><br>
<a href="https://range-reserver.net/full-calendar/">**Full calendar NEW**</a><br>
<a href="https://range-reserver.net/demo-standard-single-column-layout/">**Standard Appointment form**</a><br>

= Doc =
<a href="https://range-reserver.net/documentation/">Documentation</a>
...
* Multiple **Bays**
* Multiple **Lanes**
    - Create dedicated calendar for one location / bay / lane
* Create time slots by connecting location – bay – lane and date/time
    - Multiple time slots
    - Fine granular option for creating even most complex time table
    - **Bulk schedules builder**
...
* **Email notifications :**
    ...
    - Send email notification to lane
...
* **Internationalization** - support for translations (you can create your own translation <a href="https://range-reserver.net/documentation/#translate">>> tutorial <<</a>)
...
There is extension plugin that you can buy and add to your Range Reserver plugin :
...
For more info follow the link for <a href="https://range-reserver.net/#extension">Extension plugin</a>

= HomePage =
<a href="https://range-reserver.net/">range-reserver.net</a>
...
<a href="https://range-reserver.net/documentation/#bootstrap">all available shortcode options</a>

example : [rr_bootstrap width="800px" scroll_off="true" layout_cols="2"]

== Frequently Asked Questions ==

= How to set custom cron task for clearing reserved slots =
Create cron task on your host that have this link : `wget -q -O - <STIE_URL>/?_rr-action=clear_reservations > /dev/null 2>&1` . This will delete all reservations older than 6min.
...
= How to hide bay / location / lane in front end part of form? =

To do this you must create one location / lane or bay and set Name that starts with underscore. For example : *_dummy*, *_location*...
...
= How to set multiple slots for one combination of location, bay, lane? =

To add more slots per (location, bay, lane) combination just clone the existing one. For two slots you need to
have that schedule twice.

= How to insert Range Reserver widget on Page/Post? =
...
Example :
`[rr_bootstrap width="800px" scroll_off="true" layout_cols="2"]`
...
= How to create calendar only for one lane / bay / location =
If you want to have separate calendars base on lane for example. You can do that by setting default lane inside short code.
`[rr_bootstrap lane="1"]`
Value is lane #id number. Examples :

`[rr_bootstrap lane="1"]`
`[rr_bootstrap lane="1" location="1"]`
`[rr_bootstrap lane="1" location="1" bay="1"]`

Note: you can have only one calendar on one page.

== Screenshots ==

1. Responsive front end two column `[rr_bootstrap layout_cols="2"]` - part1
2. Responsive front end two column `[rr_bootstrap layout_cols="2"]` - part2
3. Responsive front end shortcode `[rr_bootstrap]` - part1
4. Responsive front end shortcode `[rr_bootstrap]` - part2
5. Standard front end form for Appointment `[rr_standard]`
6. Full Calendar short code
7. Admin panel - Appointments list
8. Admin panel - Settings Location. Define your Locations
9. Admin panel - Settings Bays. Define your Bays
10. Admin panel - Settings Lanes. Define your Lanes
11. Admin panel - Settings Schedule. Set single combination for location, bay, lane
12. Admin panel - Settings - Bulk schedule creation
...
= 3.7.2 (2022-02-06) =
* Improved callback hook when appointment is created in `rr_bootstrap`s shortcode
...
= 3.5.7 (2021-09-26) =
* Bulk option for adding new Schedules
...
* Fixed date/time format on Schedules admin page in table

= 3.5.5 (2021-08-04) =
* NEW Allow confirmation by email link for bookings that have status reservation in case it is default status.

= 3.5.4 (2021-07-25) =
* NEW Daily limit option on bay. You can now set hard limit for number of booking for particular bay during one day
* Fixed issue with warning message on Confirm/Cancel action from mail

= 3.5.3 (2021-06-21) =
* NEW Reports page - early access
* Bays - now it is possible to have slot step with values 3,4 if duration of bay is less then 5 minutes

= 3.5.2 (2021-05-16) =
* Improved Slot Step bay field
* Fixed issue with date selector in Schedules forms
...
= 3.4.10 (2021-03-29) =
* Fixed issue with default 0 values in Admin Bay form
...
= 3.4.5 (2021-03-13) =
* Closure settings now works on rr_standard shortcode
...
= 3.4.3 (2021-02-15) =
* Fixed issue with empty schedules page
...
= 3.4.1 (2021-02-12) =
* Fixed issue with block before/after bay time

= 3.4.0 (2021-02-11) =
* New design for Schedules and Tools admin page

= 3.3.2 (2021-02-05) =
* Masked field can be set as required

= 3.3.1 (2021-02-03) =
* Added hook for time selection in form `rangeappslotselects`.
...
= 3.2.3 (2021-01-10) =
* Added Id column to Locations, Bays and Lanes admin page

= 3.2.2 (2021-01-04) =
* Fixed issue with editing bays and missing values in form

= 3.2.1 (2020-12-28) =
* Compatibility with older WP versions (before 5)

= 3.2.0 (2020-12-27) =
* Admin - new settings pages for Locations, Lanes and Bays
...
= 3.1.1 (2020-11-29) =
* Fixed issue with missing image resources on closure screen

= 3.1.0 (2020-11-29) =
* Added Closure settings in Admin panel. Now you can select closure days for lanes that will be block on `rr_bootstrap` shortcode.

= 3.0.15 (2020-11-22) =
* Added option for fullcalendar shortcode to select current logged lane `lane="logged"`
* Improved Bay/Location/Lane accessibility via tab key
* Improved styles
...
= 3.0.13 (2020-10-30) =
* Fixed issue with Lane and Location mixed in form
...
= 3.0.9 (2020-10-20) =
* Fixed issue with label above field that was not working in [rr_bootstrap]
...
= 3.0.5 (2020-09-21) =
* Added option for custom default label for Select field in [rr_bootstrap] shortcode called `select_placeholder`. Default value is '-'

= 3.0.4 (2020-08-23) =
* Added option for labels above fields for [rr_bootstrap] shortcode
...
= 2.13.4 (2020-05-24) =
* Added shortcode option to prevent date auto select day when calendar is first step (`rr_bootstrap`)
* Added shortcode option for button label customization for full calendar (`rr_full_calendar`)

= 2.13.3 (2020-05-17) =
* Added new option for FullCalendar shortcode (`time_format`, `display_event_end`)
* Added option to hide price in select field in customers form (shortcode rr_standard rr_bootdstrap)
...
= 2.10.1 (2020-01-07) =
* Small Fix for schedules slot number

= 2.10.0 (2020-01-05) =
* Added option for slot count on schedule level. Now you don't need to have same schedules to increase number of slots, just alter that value on schedule level
* Now you can override booking overview template inside you theme under (`theme-folder/range-reserver/booking.overview.tpl.php`)
...
= 2.7.1 (2019-10-28) =
* Additional improvement to full calendar short code. If Location, Lane or Bay id is not defined it will show all.
...
* Preparation for FullCalendar widget for Lanes
...
= 2.4.4 (2019-06-03) =
* Added custom redirect based on selected Bay. Now user can be redirected to a page based by bay after booking.
...
= 2.3.10 (2019-01-09) =
* Improved style of bootstrap customers form (shortcode `rr_bootstrap`)
...
= 2.3.7 (2018-08-26) =
* Added options for Sorting Location, Bays and Lanes for both customers form and Admin section
...
= 2.3.3 (2018-06-11) =
* Fixed issue with split time for bays and time selection in form
...
= 2.3.0 (2018-05-12) =
* Fixed issue with Events Calendar plugin that prevent activation of RangeReserver
...
* Fixed issue with missing schedule inside settings
...
= 1.12.2 (2017-11-4) =
* Fixed issue with WordPress 4.8.3 and options that didn't load on customers form (location, bays and lanes)

= 1.12.1 (2017-11-3) =
* Fixed issue with missing Schedules page and not loading the bays
* Fixed issue with bulk creation of Schedules

= 1.12.0 (2017-10-16) =
* Security fix in admin panel - now only user with `manage_options` capability can see Settings and Report page in menu and alter settings regarding RangeReserver. Settings values are escaped preventing users to add malicious values. (big thank you goes to Ricardo Sanchez for this one)
...
* New short-code attribute for showing remaining slots. Example `[rr_bootstrap show_remaining_slots="1"]` or `[rr_standard show_remaining_slots="1"]`

= 1.11.5 (2017-08-27) =
* Improved Location/Bay/Lane filter selection on Appointments page in admin section.
* Admin Appointments page has new sort by name for Locations, Bays and Lanes
...
* Improved Location/Bay/Lane selection on Appointments page in admin section. Now user can only select valid combination of Location, Bay and Lane.

= 1.11.2 (2017-08-04) =
* Fixed issue with removed default editor so now customize page can work even if tinyMCE is turned off for the whole site.

= 1.11.1 (2017-07-30) =
* Added additional filter `rr_can_make_reservation` callback
...
* Fixed issue with bay and currency within select field
...
= 1.10.0 =
* Added *Bulk* schedule creation. Now it's possible to create multiple schedules with one click
...
= 1.9.10 =
* Bug fix: schedule clone option didn't copy "date to" value
...
* Change in selecting time from schedules. Now it will include both start date and end date in calculation.

= 1.9.6 =
* Responsive layout for Appointments Admin page

= 1.9.5 =
* New options - send admin email to lane (lane)
...
* Bug fix - selecting bays on frontend
...
= 1.8.14 =
* Support for bootstrap short code - create dedicated calendar for single Location / Bay / Lane
...
= 1.8.13 =
* Added new email tags : #bay_duration#, #bay_price#, #lane_email#, #lane_phone#, #location_address#, #location#
...
= 1.8.7 =
* Fixed - all slots seems to be busy when translation has been used (not english version). If you had this problem plase edit all schedules and reselect days in week/
...
* UTF8 email encoding
* Option for turning of Location/Bays/Lane by setting dummy records. Set name that starts with underscore (for example :*_dummy*).
...
* New options for lane, before free slots are calculated only for current bay type. Now you can calculate free slots for all bays for that lane
...
* Fix bug with clone button in settings/schedule
...
= 1.2.9 =
* Fix for bug on editing location/bay/lane that delete schedule.
...
= 1.2.0 =
* New shortcode for bootstrap version of frontend form `[rr_bootstrap]`
...
= 1.2.2 =
* Please take upgrade with great care. There has been database changes regarding reference integrity of data. So upgrade will remove appointments/schedules that don't have some key value (location, lane, bay).
