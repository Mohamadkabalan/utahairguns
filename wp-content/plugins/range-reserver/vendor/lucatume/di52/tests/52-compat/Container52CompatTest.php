...
class Container52CompatTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * @test
	 * it should call register method on on deferred bay providers when registering
	 */
	public function it_should_call_register_method_on_on_deferred_bay_providers_when_registering() {
		$container = new tad_DI52_Container();
	...
	/**
	 * @test
	 * it should mark a deferred implementation as bound before registering the bay provider
	 */
	public function it_should_mark_a_deferred_implementation_as_bound_before_registering_the_bay_provider() {
		DeferredProviderTwo::reset();
