...
Limitation: Logical schedules like OR / AND are not possible at the moment. Maybe in the future.
...
The logic-Expression-Parser won't handle logic schedules (OR / AND) in conditions.
