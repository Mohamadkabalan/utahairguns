...
class Renderer
{
     ...
     */
    public function __construct(\FedExVendor\WPDesk_Plugin_Info $plugin_info, bool $update_possible)
    {
    ...
    {
        $form_content = new \FedExVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->update_possible);
