...
class AjaxHandler implements \FedExVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function handle_ajax_action()
    {
        ...
        $form_content_renderer = new \FedExVendor\WPDesk\License\ActivationForm\FormContentRenderer($this->plugin_info, $this->is_update_possible(isset($update_plugins[$this->plugin_info->get_plugin_file_name()]) ?? new \stdClass()), $license_page_action->get_errors());
