...
use FedExVendor\WPDesk\License\WpUpgrader\SubscriptionHandler;
...
class LicenseManager implements \FedExVendor\WPDesk\PluginBuilder\Plugin\HookableCollection
{
    ...
    {
        $this->add_hookable(new \FedExVendor\WPDesk\License\WpUpgrader\SubscriptionHandler($this->plugin_info->get_plugin_file_name(), $activated, $subscriptions_url));
    }
    /**
     * .
     */
